...
Memory-bandwidth optimised version of [`do_transport`](@ref) using transposed matrix `dtm_tr`.
...
#########################################################################################################
# Optimized transport using transport matrices stored as multiple SparseArrays.SparseMatrixCSC 
# with a common sparsity pattern
#########################################################################################################
...
This allows fast interpolation for eg a time-series of transport matrices over a
seasonal cycle.
...
function _kernel_transport_tr_packed(
